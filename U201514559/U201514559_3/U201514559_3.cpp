...
int main(int argc, char* argv[])
{
	...
	ofstream MyFile("U201514559_3.txt");//新建一个对应文件名的文本文档
			...
			case 1://入栈
				{
					...
					if ((stack1<<push_e).size() == 0)//判断入栈结果返回值
					{
						cout << "  " << "E";
						MyFile << "  " << "E";
						return -1;
			...
			case 4://深拷贝赋值
				{
					...
					stack3 = stack1;//assign
					stack1 = stack3;//把新栈赋值给旧栈，以后操作新栈
					break;
				}
			case 5://剩余元素个数
				break;
